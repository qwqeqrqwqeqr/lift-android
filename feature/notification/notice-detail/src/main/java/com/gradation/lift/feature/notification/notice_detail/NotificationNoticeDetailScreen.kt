...
@Composable
fun NotificationNoticeDetailRoute(
    ...
    NotificationNoticeDetailScreen(
        modifier,
        selectedNotice,
        navigateNoticeDetailToNotificationInNotificationGraph
    )
}

@Composable
fun NotificationNoticeDetailScreen(
    modifier: Modifier = Modifier,
