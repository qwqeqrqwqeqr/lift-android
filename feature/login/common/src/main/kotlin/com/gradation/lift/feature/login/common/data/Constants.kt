...
1. 회원 가입 및 관리 회원 가입 의사 확인, 이용자의 본인 확인, 이용자 식별, 회원탈퇴 의사의 확인와 같이 회원관리를 위하여 개인정보를 이용합니다.
2. 신규 서비스 개발 및 개선 개인 정보의 기반하에 사용자에게 새로운 서비스를 제공하기 위해 개인정보를 이용합니다.
3. 서비스 운영 및 유지보수를 위한 통계 자료 도출
2. 수집되는 개인정보
1. 회원 가입시 수집되는 개인정보 이메일, 비밀번호, 닉네임, 신장, 체중, 성별
2. 프로필 사진 프로필 사진을 지정할 경우 프로필 사진 정보를 수집합니다.
3. 개인정보의 처리 및 보유 기간
...
제1조(목적)
1. 본 약관은 리프트가 제공하는 서비스(이하 '서비스'라 합니다)를 이용함에 있어 당사자의 권리 의무 및 책임사항을 규정하는 것을 목적으로 합니다.
...
부 칙
제1조(시행일)
본 약관은 2023.12.27부터 적용합니다.
서비스 이용약관
제1조(목적)
이 약관은 리프트가 제공하는 제반 서비스의 이용과 관련하여 회원과의 권리, 의무 및 책임사항, 기타 필요한 사항을 규정함을 목적으로 합니다.
제2조(정의)
...
제1조(목적)
1. 본 약관은 리프트가 운영하는 온라인 쇼핑몰 ''에서 제공하는 서비스(이하 '서비스'라 합니다)를 이용함에 있어 당사자의 권리 의무 및 책임사항을 규정하는 것을 목적으로 합니다.
2. PC통신, 무선 등을 이용하는 전자상거래에 대해서도 그 성질에 반하지 않는 한 본 약관을 준용합니다.
제2조(정의)
1. '회사'라 함은, '리프트'가 재화 또는 용역을 이용자에게 제공하기 위하여 컴퓨터 등 정보통신설비를 이용하여 재화등을 거래할 수 있도록 설정한 가상의 영업장을 운영하는 사업자를 말하며, 아울러 ''을 통해 제공되는 전자상거래 관련 서비스의 의미로도 사용합니다.
2. '이용자'라 함은, '사이트'에 접속하여 본 약관에 따라 '회사'가 제공하는 서비스를 받는 회원 및 비회원을 말합니다.
