...
fun NavGraphBuilder.updateInfoScreen(
    ...
    composable(
        route = "${HISTORY_UPDATE_INFO_ROUTER_NAME}?$HISTORY_COMMENT_KEY={${HISTORY_COMMENT_KEY}}&$HISTORY_SCORE_KEY={${HISTORY_SCORE_KEY}}&$HISTORY_ID_KEY={${HISTORY_ID_KEY}}&$HISTORY_DATE_KEY={${HISTORY_DATE_KEY}}",
        arguments = listOf(
            ...
            navArgument(HISTORY_ID_KEY) {
                type = NavType.IntType
                defaultValue = 0
            },
            navArgument(HISTORY_DATE_KEY) {
                type = NavType.StringType
                defaultValue = ""
            },
        ),
