package com.gradation.lift.feature.home.home.ui.component.bottomSheet
...
internal fun WorkBottomSheet(
    ...
    LiftBottomSheet(
        modifier = modifier,
        onDismissRequest = { homeScreenState.updateWorkBottomSheetView(false) },
        dragHandle = null,
    ) {
        Column(
            modifier = modifier
            ...
            Row(
                ...
                Icon(
                    modifier = modifier
                        ...
                        .noRippleClickable {
                            homeScreenState.updateWorkBottomSheetView(false)
                        },
