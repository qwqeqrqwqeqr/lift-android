...
class CheckerRemoteDataSourceTest {
    ...
    private lateinit var checkerRemoteDataSource: CheckerRemoteDataSource
    ...
    fun setUp() {
        ...
        checkerRemoteDataSource = DefaultCheckerRemoteDataSource(
            checkerService,
    ...
    fun checkDuplicateEmailDataSource() = runTest {
        ...
        with(checkerRemoteDataSource.checkDuplicateEmail(FAKE_STRING_DATA).first()) {
            Truth.assertThat(
    ...
    fun checkDuplicateNameDataSource() = runTest {
        ...
        with(checkerRemoteDataSource.checkDuplicateName(FAKE_STRING_DATA).first()) {
            Truth.assertThat(
                NetworkResult.Success(
                    FAKE_BOOLEAN_DATA,
                    message = DefaultDataGenerator.FAKE_MESSAGE_DATA
